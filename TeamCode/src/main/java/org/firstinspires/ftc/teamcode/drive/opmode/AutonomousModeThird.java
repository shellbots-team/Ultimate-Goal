...
public class AutonomousModeThird extends LinearOpMode {
	...
	public static double armRaisePower = 0.425;
	...
	public static double cThirdPositionH = 0;
	public static double cThirdPositionT = 0;
	public static double cThirdPositionX = 40;
	public static double cThirdPositionY = 45;
	...
	public static double eFifthPositionX = 98;
	public static double eFifthPositionY = 19.5;
